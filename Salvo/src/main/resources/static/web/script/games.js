var appVue = new Vue({
    ...
    methods: {
        ...
        playersList: function () {
            ...
            // checking if a player is repeated and then pushing them to a new array appVue.players.email
            $.each(appVue.player, function(i, el){
                if($.inArray(el, appVue.players.email) === -1) appVue.players.email.push(el);
            });
        },
